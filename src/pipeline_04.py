# pipeline com observabilidade
# consegue fazer deploy de forma gratuita no render
...
import logging
import logfire # instalar logfire
...
logfire.instrument_requests() # essa biblioteca já cria vários logs padrões das bibliotecas que usei
...
def criar_tabela():
    ...
    logger.info("Tabela criada/verificada com sucesso!") #aonde tinha print troquei para logger.info
