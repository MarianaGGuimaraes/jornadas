...
#faz conexão com  meu bd postgresql
def ler_dados_postgres():
    ...
    try:
        ...
        query = "SELECT * FROM bitcoin_precos ORDER BY timestamp DESC" #a mesma query que faço aqui no streamlit posso fazer no bd
...
#métodos do dash. Transforma em dataframe, header, etc. 
def main():
